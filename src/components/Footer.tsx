            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-24">
                    ...
                    <div className="space-y-6 lg:col-span-2">
                        ...
                        <ul className="space-y-4 text-[14px] font-semibold">
                            <li><Link href="/blog" className="group flex items-center gap-2 hover:text-brand-orange transition-colors"><span className="text-brand-orange opacity-40 group-hover:opacity-100 transition-opacity">›</span> Blog</Link></li>
